            ...
            <div className="row">
                ...
                <div className="col-6 p-md-0">
                    <ul className="social-icons">
                        <li className="mr-2">
                            <a className="rounded-circle sticker sticker-secondary" href={`${githubRepo}/issues`} target="_blank">
                        ...
                        <li>
                            <a className="rounded-circle sticker sticker-secondary" href={`${githubRepo}`} target="_blank">
